...
For development and testing purposes, we can simply disable all authentication and authorization features by setting the
`VITE_APP_AUTH_DISABLED` configuration to `false`.
