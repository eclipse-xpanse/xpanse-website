...
4. Start/Stop/Restart - This option can be used to start/stop/restart the service. Currently, this option controls only virtual machines that are used in the service.
5. Migrate - This option is used to migrate an existing service to another CSP.
6. Lock/Unlock - This option can be used for locking the services from accidental deletion or modifications.
7. Update service configuration parameters.
