...
Or even if the service needs the end user to select multiple availability zones, even that is possible. The availability zone information can be directly injected into deployment scripts.
