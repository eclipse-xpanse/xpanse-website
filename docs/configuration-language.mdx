...
> Note: Examples of managed services described using XSDL for multiple clouds can be found in the
>
> <Link name={'samples repository'} url={'https://github.com/eclipse-xpanse/xpanse-samples/tree/main'} />.
